...
const Profil = () => {
    ...
    return (
        <main className="overflow-hidden h-[5000px]">
            {/* HEADER */}
            <Header />
                ...
                <div className="px-32 py-24 flex items-center gap-44">
                    <div>
                        <RevealText className="font-medium text-lg text-slate-800 mb-8" type="words" scroll={true} stagger={0.01} bottom={50}>
                            ...
                            itu, pepatah Minangkabau, "anak dipangku kamanakan dibimbiang" masih kental dijalankan di kampung halamannya,
                            Payakumbuh.
                            <br /><br />
                            Saat kelas IV SD, ia meninggalkan Payakumbuh dan pergi merantau ke Tanjung Pinang, Kepulauan Riau untuk
                            melanjutkan sekolah bersama etek-nya. Sedari dulu, orang tua di kampungnya telah menanamkan budaya pendidikan adalah hal
                            utama bagi anak, “Biarlah kurang makan asal anak sekolah”.
                            <br /><br />
                            Ganefri menyelesaikan pendidikan SD (1976) dan SMP Belakang
                            Padang (1980) di Batam. Ia lalu menyelesaikan pendidikan SLTA di Tanjung Pinang (1983). Ia menyelesaikan studi S1
                            Pendidikan Elektro dari IKIP Padang (1988) dan S2 Pendidikan Teknik dan Kejuruan dari IKIP Yogyakarta (1996). Ia berhasil
